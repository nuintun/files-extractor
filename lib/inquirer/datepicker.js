    ...
    switch (str) {
      ...
      case 'DD':
        selection.elements.push({
          ...
          set: value => {
            selection.date = validateDate(setDate(selection.date, { day: value }));
          }
        });
        break;
      case 'M':
      ...
      case 'MMMMM':
        selection.elements.push({
          ...
          set: value => {
            ...
            selection.date = validateDate(setDate(selection.date, { month: value - 1 }));
          }
        });
        break;
      case 'YY':
        selection.elements.push({
          ...
          set: value => {
            ...
            selection.date = validateDate(setDate(selection.date, { year: 2000 + value }));
          }
        });
        break;
      case 'YYYY':
        selection.elements.push({
          ...
          set: value => {
            ...
            selection.date = validateDate(setDate(selection.date, { year: value }));
          }
        });
        break;
      case 'h':
        ...
        selection.elements.push({
          ...
          set: value => {
            ...
            if (selection.date.getHours() <= 12) {
              selection.date = validateDate(setDate(selection.date, { hour: value }));
            } else {
              selection.date = validateDate(setDate(selection.date, { hour: value + 12 }));
            }
          }
        });
        break;
      ...
      case 'mm':
        selection.elements.push({
          ...
          set: value => {
            ...
            selection.date = validateDate(setDate(selection.date, { minute: value }));
          }
        });
        break;
      case 's':
      case 'ss':
        selection.elements.push({
          ...
          set: value => {
            ...
            selection.date = validateDate(setDate(selection.date, { second: value }));
          }
        });
        break;
      case 'SSS':
        selection.elements.push({
          ...
          set: value => {
            ...
            selection.date = validateDate(setDate(selection.date, { millisecond: value }));
          }
        });
        break;
      case 'A':
...
Prompt.prototype.onKeypress = function(e) {
  ...
  if (Number.isInteger(number = parseInt(e.value, 10))) {
    selection.value = ((selection.value * 10) + number);
